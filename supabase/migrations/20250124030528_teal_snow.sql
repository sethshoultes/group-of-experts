/*
  # Restore Working Schema
  
  This migration restores the database schema to match the working deployed version.
  
  1. Tables
    - api_keys: Store user API keys
    - discussions: Store discussion threads
    - messages: Store discussion messages
    - admin_users: Store admin user info
