/*
  ...
  1. New Tables
    - `api_keys`
      - Stores user API keys for OpenAI
      - Includes key management and usage tracking
    - `discussions`
      - Stores user discussions
      - Supports sequential and parallel modes
      - Tracks expert assignments and rounds
    - `messages`
      - Stores discussion messages
      - Includes expert references and metadata
    - `admin_users`
